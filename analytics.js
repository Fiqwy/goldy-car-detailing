/* ==========================================================================
 * Goldy Car Detailing — first-party visitor beacon (Phase DP2)
 * Cookieless. Reports a pageview on load and Call/Text/Book taps to the
 * Applied Intelligence backend, so Gracie sees visitor stats in her dashboard.
...
(function () {
  ...
  var SLUG = 'goldy-car-detailing';

  // The specific booking-intent buttons. They all resolve to an SMS to Gracie,
  // but carry an explicit "book / quote / build" intent, so we count them as the
  // more specific 'book' rather than a generic 'sms' tap.
  var BOOK_SELECTOR = '#maintBook, #buildBook, #condSms, #contactForm button[type="submit"]';
